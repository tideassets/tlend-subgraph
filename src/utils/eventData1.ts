...
export class EventData1 {
  ...
  getAddressItem(key: string): Address | null {
    return getItemByKey<Address, EventLog1EventDataAddressItemsItemsStruct>(this.rawData.addressItems.items, key);
  }
  ...
  getAddressArrayItem(key: string): Array<Address> | null {
    return getItemByKey<Array<Address>, EventLog1EventDataAddressItemsArrayItemsStruct>(
  ...
  getStringArrayItem(key: string): Array<string> | null {
    return getItemByKey<Array<string>, EventLog1EventDataStringItemsArrayItemsStruct>(
  ...
  getUintItem(key: string): BigInt | null {
    return getItemByKey<BigInt, EventLog1EventDataUintItemsItemsStruct>(this.rawData.uintItems.items, key);
  }

  getUintArrayItem(key: string): Array<BigInt> | null {
    return getItemByKey<Array<BigInt>, EventLog1EventDataUintItemsArrayItemsStruct>(
  ...
  getBytesItem(key: string): Bytes | null {
    return getItemByKey<Bytes, EventLog1EventDataBytesItemsItemsStruct>(this.rawData.bytesItems.items, key);
  }

  getBytesArrayItem(key: string): Array<Bytes> | null {
    return getItemByKey<Array<Bytes>, EventLog1EventDataBytesItemsArrayItemsStruct>(
  ...
  getBytes32Item(key: string): Bytes | null {
    return getItemByKey<Bytes, EventLog1EventDataBytes32ItemsItemsStruct>(
      this.rawData.bytes32Items.items, // as Array<EventLog1EventDataBytesItemsItemsStruct>,
      key
    );
  }
